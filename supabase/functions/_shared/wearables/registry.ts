...
// Platform v2 + Phase 2 adapters — first CI deploy to CM OS on 2026-09-14, second attempt after the workflow fix (a change here deploys all six connector functions).
